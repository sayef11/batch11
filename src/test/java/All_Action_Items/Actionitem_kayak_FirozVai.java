...
import java.util.ArrayList;
    ...
    public class Actionitem_kayak_FirozVai {
...
//for loop starts
            for (int i = 1; i < row; i++) {
                ...
                //Reusable_Library.KeyEnter(driver, "//*[@name='pickup']", "Enter","entering");
                //Delaying for 2sec
                Thread.sleep(2000);
                ...
                Thread.sleep(1500);
                //Using keyboard command: Enter
                //Reusable_Library.KeyEnter(driver, "(//div[@aria-label='Drop-off date']) [2]", "hit Enter","entering");
                ...
                //Hitting Enter
              // Reusable_Library.KeyEnter(driver, "(//div[@aria-label='Pick-up date']) [2]", "Hitting Enter","entering");
                //Delaying for 3 sec
                Thread.sleep(3000);
