        ...
        public class WeightWatchers2 {
            ...
            public static void main(String[] args) throws InterruptedException {
                ...
                for (int i = 0; i <=2; ++i) {
                    ...
                    String Address = driver.findElement(By.xpath("//*[@class = 'location__container']")).getText();
                    //Hold for 3sec
                    Thread.sleep(3000);
                    ...
                    String Chart = driver.findElement(By.xpath("//*[@class='meeting-detail-bottom-top']")).getText();
